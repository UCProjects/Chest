...
<head>
  <style>
    ...
    body { font-family: 'DTM-Mono'; --dt: rgb(255, 0, 0); --patience: rgb(65, 252, 255); --bravery: rgb(252, 165, 0); --integ: rgb(0, 100, 255); --pers: rgb(213, 53, 217); --kindness: rgb(0, 192, 0); --justice: rgb(255, 255, 0); --font: rgb(255, 255, 255); --border: rgb(255, 255, 255); background-color: black; padding-top: 1px; width: 166px; }
    ...
    .status, .tribes { position: absolute; right: 2px; }
    .status { top: 4px; }
    .tribes { bottom: 0px; }
